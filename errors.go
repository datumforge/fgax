...
var (
	...
	// ErrMissingObjectInModel is returned when an object is missing in the model
	ErrMissingObjectInModel = errors.New("unable to create role, object type not found in model")
)
